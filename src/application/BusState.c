...
static BS_Configuration_t BS_config =
    {
        .controlDirection = eIN,
        .dataDirection = eIN,
        .state = eSlave,
        .busAquired = false};
...
/**
 * @brief Requests Bus control from the Z80 Bus Master and waits for the BUSACK signal from it
 *
 */
static void BS_AquireBus()
{
...
/**
 * @brief Sets the direction of MCU and Level Shifter Data Bus pins in correct sequence to prevent contention
 *
...
/**
 * @brief Sets the direction for the of MCU and Level Shifter Address/CTRL Bus pins in correct sequence to prevent contention
 *
 * @param direction Direction to switch the bus to
 */
static void BS_SetControlBusDirection(BS_Direction_t direction)
